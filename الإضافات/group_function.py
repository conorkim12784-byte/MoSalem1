...
########################################################################################################################
    ...
    if m.text == "قرءان" or m.text == "قران" or m.text == "قرآن" or m.text == "القرآن" or m.text == "قران ♥️":
        await quran(c, m)
        return
    ...
    if m.text == "الافلام" or m.text == "افلام" or m.text == "الافلام 🎥" or m.text == "فيلم" or m.text == "افلامي"\
    ...
    if m.text == "كارتون" or m.text == "كارتون 🦕" or m.text == "كرتون":
        if await lock_aflam_test(m) and not constractors(m):
            await m.reply_text("⌔ الافلام مقفوله اطلب من الادمن فتحها",
                               reply_to_message_id=m.message_id)
            return
